...
export declare function polymorphic<K, T>(kind: K, value: T): Polymorphic<K, T>;
...
export type TypeDto = Polymorphic<'AnyType', AnyTypeDto> | Polymorphic<'UnknownType', UnknownTypeDto> | Polymorphic<'VoidType', VoidTypeDto> | Polymorphic<'NeverType', NeverTypeDto> | Polymorphic<'UnionType', UnionTypeDto> | Polymorphic<'IntersectionType', IntersectionTypeDto> | Polymorphic<'TupleType', TupleTypeDto> | Polymorphic<'BooleanType', BooleanTypeDto> | Polymorphic<'NumberType', NumberTypeDto> | Polymorphic<'BigIntType', BigIntTypeDto> | Polymorphic<'StringType', StringTypeDto> | Polymorphic<'NullType', NullTypeDto> | Polymorphic<'UndefinedType', UndefinedTypeDto> | Polymorphic<'LiteralType', LiteralTypeDto> | Polymorphic<'ClassType', ClassTypeDto> | Polymorphic<'FunctionType', FunctionTypeDto> | Polymorphic<'ArrayType', ArrayTypeDto> | Polymorphic<'UnclearReferenceType', UnclearReferenceTypeDto> | Polymorphic<'GenericType', GenericTypeDto> | Polymorphic<'AliasType', AliasTypeDto> | Polymorphic<'AnnotationNamespaceType', AnnotationNamespaceTypeDto> | Polymorphic<'AnnotationTypeQueryType', AnnotationTypeQueryTypeDto> | Polymorphic<'EnumValueType', EnumValueTypeDto> | Polymorphic<'LexicalEnvType', LexicalEnvTypeDto> | UnhandledTypeDto;
...
export type ValueDto = Polymorphic<'Local', LocalValueDto> | Polymorphic<'Constant', ConstantValueDto> | Polymorphic<'NewExpr', NewExprDto> | Polymorphic<'NewArrayExpr', NewArrayExprDto> | Polymorphic<'DeleteExpr', DeleteExprDto> | Polymorphic<'AwaitExpr', AwaitExprDto> | Polymorphic<'YieldExpr', YieldExprDto> | Polymorphic<'TypeOfExpr', TypeOfExprDto> | Polymorphic<'InstanceOfExpr', InstanceOfExprDto> | Polymorphic<'CastExpr', CastExprDto> | Polymorphic<'PhiExpr', PhiExprDto> | Polymorphic<'ConditionExpr', ConditionExprDto> | Polymorphic<'BinopExpr', BinopExprDto> | Polymorphic<'UnopExpr', UnopExprDto> | Polymorphic<'InstanceCallExpr', InstanceCallExprDto> | Polymorphic<'StaticCallExpr', StaticCallExprDto> | Polymorphic<'PtrCallExpr', PtrCallExprDto> | Polymorphic<'ThisRef', ThisRefDto> | Polymorphic<'ParameterRef', ParameterRefDto> | Polymorphic<'ArrayRef', ArrayRefDto> | Polymorphic<'CaughtExceptionRef', CaughtExceptionRefDto> | Polymorphic<'GlobalRef', GlobalRefDto> | Polymorphic<'ClosureFieldRef', ClosureFieldRefDto> | Polymorphic<'InstanceFieldRef', InstanceFieldRefDto> | Polymorphic<'StaticFieldRef', StaticFieldRefDto> | UnhandledValueDto;
...
export type StmtDto = Polymorphic<'AssignStmt', AssignStmtDto> | Polymorphic<'CallStmt', CallStmtDto> | Polymorphic<'IfStmt', IfStmtDto> | Polymorphic<'ReturnVoidStmt', ReturnVoidStmtDto> | Polymorphic<'ReturnStmt', ReturnStmtDto> | Polymorphic<'ThrowStmt', ThrowStmtDto> | UnhandledStmtDto;
...
export {};
//# sourceMappingURL=JsonDto.d.ts.map