...
} from "../../../core/kernel/contracts/AppStorageModuleProvider";
import { resolveHarmonyMethods } from "../../../core/kernel/contracts/HarmonyModuleUtils";

export const harmonyAppStorageModule: TaintModule = defineModule({
