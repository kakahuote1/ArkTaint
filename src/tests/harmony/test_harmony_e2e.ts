...
function parseArgs(argv: string[]): CliOptions {
    let sourceDir = "tests/demo/harmony_e2e";
    let kernelRulePath = "tests/rules/minimal.rules.json";
    let projectRulePath = "tests/rules/harmony_e2e.rules.json";
    let k = 1;
...
async function main(): Promise<void> {
    ...
    for (const caseName of cases) {
        const expected = resolveSuiteCaseExpectation("harmony_e2e", caseName);
    ...
    console.log("====== Harmony E2E Integration Test ======");
