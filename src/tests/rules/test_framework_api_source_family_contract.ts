...
const API_FAMILY_PROBE_SPECS: ApiFamilyProbeSpec[] = [
    ...
    { family: "source.harmony.rdb", caseName: "api_rdb_changeinfo_inserted_020_T" },
    { family: "source.harmony.globalcontext", caseName: "api_globalcontext_getobject_007_T" },
    { family: "source.harmony.webview.auth_cache", caseName: "api_webdatabase_getauth_018_T" },
    { family: "source.harmony.webview.request", caseName: "api_webresource_request_url_027_T" },
    { family: "source.harmony.file", caseName: "api_fs_read_008_T" },
    { family: "source.harmony.file", caseName: "api_filepicker_select_034_T" },
    { family: "source.harmony.request", caseName: "api_request_download_010_T" },
    { family: "source.harmony.request", caseName: "api_request_downloadfile_021_T" },
    { family: "source.harmony.request", caseName: "api_request_cachedownload_023_T" },
    { family: "source.harmony.distributedkv", caseName: "api_distributedkv_get_012_T" },
    { family: "source.harmony.distributedkv", caseName: "api_distributedkv_getentries_036_T" },
    { family: "source.harmony.rpc", caseName: "api_rpc_sendrequest_reply_024_T" },
    { family: "source.harmony.ipc.messageparcel", caseName: "api_messageparcel_readstring_029_T" },
    { family: "source.harmony.security_asset", caseName: "api_security_asset_query_032_T" },
