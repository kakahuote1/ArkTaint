...
runMetamorphicSuite({
    defaults: {
        manifestPath: "tests/manifests/metamorphic/metamorphic_seed_v3.list",
        sourceDir: "tests/demo/metamorphic_seed_v2",
        tempProjectDir: "tmp/test_runs/metamorphic/seed_v3/latest/metamorphic_project",
