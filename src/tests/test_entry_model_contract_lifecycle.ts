...
async function main(): Promise<void> {
    ...
    assertFactOnClass(lifecyclePlan, "ability_lifecycle", "DemoFormExtension011", "onAddForm");
    assertNoFactOnClass(lifecyclePlan, "ability_lifecycle", "DemoFormExtension012", "onAddForms");
    assertFactOnClass(lifecyclePlan, "ability_lifecycle", "DemoFormExtension013", "onUpdateForm");
    assertNoFactOnClass(lifecyclePlan, "ability_lifecycle", "DemoFormExtension014", "onUpdateForms");
