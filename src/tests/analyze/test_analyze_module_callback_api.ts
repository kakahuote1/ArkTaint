...
async function main(): Promise<void> {
    ...
    const callbackProjectDir = path.join(moduleRoot, "project", "callback_demo", "modules");
    ...
    writeText(path.join(moduleRoot, "callback.rules.json"), stringifyRuleAssetFixture({
    ...
    writeText(path.join(callbackProjectDir, "callback_bridge.ts"), [
    ...
    runAnalyzeCli([
        ...
        "--enable-model", "callback_demo:modules",
