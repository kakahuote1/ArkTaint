...
function renderMarkdown(report: PerfCompareReport): string {
    const lines: string[] = [];
    lines.push("# Analyze vs Arktan Perf Compare");
    lines.push("");
...
async function main(): Promise<void> {
    ...
    const compareScript = path.resolve("out/tests/transfer/test_transfer_compare_arktan.js");
