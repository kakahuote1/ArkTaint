...
async function main(): Promise<void> {
    ...
    writeText(path.join(moduleRoot, "path_judgement_divergence.rules.json"), stringifyRuleAssetFixture({
    ...
    writeText(path.join(moduleProjectDir, "path_judgement_divergence_bridge.ts"), [
    ...
    assert(result.judgement.primaryReason === "not_all_paths_refuted", `expected primaryReason=not_all_paths_refuted, got ${result.judgement.primaryReason}`);
