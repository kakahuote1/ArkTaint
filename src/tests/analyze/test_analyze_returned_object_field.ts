...
async function main(): Promise<void> {
    ...
    assert(hasSink(summary, "sink.fixture.returned_object_field.authorization"), "returned Authorization field should be tainted by Base64Source");
    assert(!hasSink(summary, "sink.fixture.returned_object_field.role"), "sibling Role field must remain clean");
