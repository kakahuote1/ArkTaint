...
const ALLOWED_MODULE_CORE_IMPORTS = new Set<string>([
    ...
    "src/core/kernel/contracts/InternalModuleLoweringIR.ts",
...
const FORBIDDEN_LEGACY_PATHS = [
    ...
    "src/core/orchestration/modules/InternalModuleLoweringIRCanonicalizer.ts",
    "src/core/orchestration/modules/InternalModuleLoweringIRValidator.ts",
