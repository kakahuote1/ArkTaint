...
async function main(): Promise<void> {
    ...
    const invokeEmissions = runtime.emitForInvoke({
        ...
        canonicalApiId: "api:project:local:module=fixture%2Fmodule-runtime.d.ts:file=fixture%2Fmodule-runtime.d.ts:export=namespace%3AFixtureClass:decl=class%3AFixtureClass:member=method%3Ainstance%3AfixtureMethod:invoke=call:params=none:ret=void",
        occurrenceId: "occ.fixture.moduleRuntime.fixtureMethod",
        rawOccurrenceId: "raw.fixture.moduleRuntime.fixtureMethod",
        semanticEffectSites: [],
        args: [],
        baseValue: undefined,
