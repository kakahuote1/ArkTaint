import type { ModifierType } from "../../../../../arkanalyzer/lib/core/model/ArkBaseModel";
...
const KNOWN_ENTRY_METHOD_NAMES = new Set([
    "build",
    "render",
    "aboutToAppear",
    "aboutToDisappear",
...
export function buildArkMainExternalEntryCandidates(
    ...
    for (const cls of scene.getClasses()) {
        for (const method of cls.getMethods()) {
            ...
            if (!methodName || KNOWN_ENTRY_METHOD_NAMES.has(methodName)) {
                continue;
            }
